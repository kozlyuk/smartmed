...
from catalogue.views import Home, ProductList, ProductListFull, ProductCreate, ProductUpdate, ProductDelete
from django.views.generic.base import TemplateView


urlpatterns = [
    path('product/image/', TemplateView.as_view(template_name='image_form.html')),
    path('product/list/full', ProductListFull.as_view(), name='product_list_full'),
